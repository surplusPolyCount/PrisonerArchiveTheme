    ...
    <body>
        <nav class="navbar navbar-expand-md navbar-light bg-white sticky-top border-bottom">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <!-- desktop logo -->
                <a class="navbar-brand p-0 m-0 d-none d-md-inline outline-none" href="/"><img id="logo" style="height: 37px; width: auto;" src="/images/mini2.svg"></a>
...
<?php /* 
		<!-- important alert / unfinished site warning-->
        ...
        <div class="modal" id="contact-us" tabindex="-1" role="dialog">
          <div class="modal-dialog" role="document">
            <div class="modal-content">
              ...
              <div class="modal-body">
                <strong>Email</strong>
                <p><a href="mailto:inbox@studentinsurgent.org">inbox@studentinsurgent.org</a></p>
