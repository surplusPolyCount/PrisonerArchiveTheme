...
<div class="d-flex justify-content-center">
	<div class="col-md-8 px-2">
            <div class="taxonomy-structure pt-3">
                <?php echo get_term_parents_list(get_queried_object_id(), 'issues', array( 'separator'=>' &raquo; ' )); ?>
        	</div>
<div class="card-body px-0"><h2 class="search-title"><?php echo single_cat_title(); ?></h1></div>
<div class="card-body pt-0 px-0 border-bottom"><?php echo term_description(); ?></div>
<?php
foreach ( get_terms( array(
            ...
            echo '<div class="row mx-0"><a class="no-hover text-black taxonomy-children text-condensed" href="' . get_term_link($issue) . '">' . $issue->name . '</a></div>';
            echo (term_description($issue));
            echo '';}
